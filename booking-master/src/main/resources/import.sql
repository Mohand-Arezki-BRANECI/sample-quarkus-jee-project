...
REPLACE INTO `User` (`firstName`,`lastName`,`email`) VALUES ('Jean','Dupont','jeandupont@gmail.com');REPLACE INTO `HotelOption` (`optionName`,`optionPrice`,`hotelId`) VALUES ('Spa',50,1);
